    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        <div className={styles.column}>
          <h4 className={styles.subtitle}>Mapa del Sitio</h4>
          <div className={styles.sitemap}>
            <Link href="/" className={styles.link}>Inicio</Link>
            <Link href="/agenda" className={styles.link}>Agenda</Link>
            <Link href="/exposiciones" className={styles.link}>Exposiciones</Link>
            <Link href="/talleres" className={styles.link}>Talleres</Link>
          </div>
        </div>
        ...
        <div className={styles.column}>
          ...
          <a 
            href="https://maps.google.com/?q=Museo+de+la+Canción+Yucateca" 
            target="_blank" 
            rel="noopener noreferrer"
            className={styles.link}
          >
            Calle 57 x 48, Centro<br/>
        ...
        <div className={styles.column}>
          ...
          <div className={styles.socialGrid}>
            <a href="https://www.facebook.com/MCYUCAC" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/mcancionyucatecaac/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
            ...
            <a href="https://wa.me/529931779143" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="WhatsApp">
      ...
      <div className={styles.bottomBar}>
        <p className={styles.meta}>&copy; {new Date().getFullYear()} Museo de la Canción Yucateca, AC. Todos los derechos reservados.</p>
