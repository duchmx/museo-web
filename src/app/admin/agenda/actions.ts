 ...
 * handler exige REVALIDATE_SECRET (pensado para un webhook externo), pero un
 * componente cliente no tiene forma segura de conocer ese secreto. Al correr
 * en el servidor, esta función no necesita el handshake.
 */
